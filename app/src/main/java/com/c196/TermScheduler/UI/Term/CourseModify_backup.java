...
public class CourseModify_backup extends AppCompatActivity {
...
//                R.array.instructor_array, android.R.layout.simple_spinner_item);
    ...
    public void updateCourse() {
        model = new ViewModelProvider.AndroidViewModelFactory(CourseModify_backup.this.getApplication()).create(CourseViewModel.class);
    ...
    public void backToTermDetail() {
        Intent intent = new Intent(CourseModify_backup.this, TermDetail.class);
